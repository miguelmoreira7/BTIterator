...
public class BinarySearchTree <T extends Comparable<T>> implements Tree, Prototype<BinarySearchTree<T>> {
	...
	@Override
	public NodeIterator<T> createPreorderIterator() {
		return new PreOrderIterator(this);
	}

	@Override
	public NodeIterator<T> createInorderIterator() {
		return new InOrderIterator(this);
	}

	@Override
	public NodeIterator<T> createPostOrderIterator() {
		return new PostOrderIterator(this);
	}

	@Override
	public HeightOrderIterator<T> createHeightOrderIterator() {
		return new HeightOrderIterator(this);
	}
